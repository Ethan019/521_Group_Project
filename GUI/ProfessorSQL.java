    ...
    public void displayCourses(Connection conn, String profid){
        try{
            ...
            while(rs1.next()){
                ...
                String query2 = "select STUDENT.studid, STUDENT.FNAME, STUDENT.LNAME, REGISTEREDFOR.GRADE from STUDENT, REGISTEREDFOR WHERE STUDID = (SELECT STUDID GRADE FROM REGISTEREDFOR WHERE CRN =" +crn+");";
